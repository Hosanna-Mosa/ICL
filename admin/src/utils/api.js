...
export const adminCoinsAPI = {
  getTransactions: async (params = {}) => apiRequest(`/admin/coins/transactions${buildQueryString(params)}`),
  getUserCoins: async (params = {}) => apiRequest(`/admin/coins/users${buildQueryString(params)}`),
